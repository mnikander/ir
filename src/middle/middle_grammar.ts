...
export type Own          = [ tag: 'own',           destination: Let, value: Read | Move ]; // cannot be lowered yet, LIR is missing the corresponding functionality
export type Borrow       = [ tag: 'borrow',        destination: Let, value: Read | Move ]; // take the address of a resource and create a read-only pointer
